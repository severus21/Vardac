...
(* TODO add support for annotation for components (needs to bind annotation to component)
@capturable(
    CounterInterceptor, 
    [] excluded ports
)
...
component B () {
    ...
    port truc on this._b :: bridge<A, B, inline p_pingpong> expecting ?ping!pong. = this.handle_ping;
