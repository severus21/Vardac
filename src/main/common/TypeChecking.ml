...
module Make () = struct
    ...
    let logger = Core.Utils.make_log_of "TypeChecking"
    ...
    *)
    ...
    and tcheck_component_item citem= map0_place (transparent0_plgannot _tcheck_component_item) citem
    ...
    and tcheck_term t = map0_place (transparent0_plgannot _tcheck_term) t
