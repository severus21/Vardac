...
%token LANGLEBRACKET RANGLEBRACKET LPBRACKET RPBRACKET LBRACKET RBRACKET SEMICOLON COMMA LCURLYBRACKET RCURLYBRACKET MID COLON DOUBLE_COLON
...
%token COMPONENT EXPECTING SIGNATURE METHOD OUTPORT EPORT INPORT ENSURES INVARIANT RETURNS STATE WITH CONTRACT SIG ON AND METADATA BBRANCH
...
%token DEPENDENCIES IMPL HEADERS RAW TARGET WHERE
